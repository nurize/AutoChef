...
import ArrowUpButton from './ArrowUpButton';  // Import ArrowUpButton

const StatisticCard = ({ iconBgColor, iconColor, count, title, arrowUpBgColor, isBookedServices, bgColor, onArrowClick }) => (
